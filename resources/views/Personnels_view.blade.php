            ...
            <div class="x_panel">
                <div class="x_content">
                    <form  ng-app="ngPersonnelsApp" ng-controller="ngPersonnelsAppcontroller" id="Personnels-form" class="form-horizontal form-label-left" method="post" action='{!! route("Personnelscreateorupdate") !!}' autocomplete="off">
                        ...
                        <table class="table table-striped" ><tr><td >Personnel name</td><td><%PersonnelsItem.per_name%></td></tr><tr><td >Personnel Contact</td><td><%PersonnelsItem.per_contact%></td></tr></table>
